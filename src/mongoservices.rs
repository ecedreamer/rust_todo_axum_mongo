use mongodb::{bson::{self, oid::ObjectId, Document}, options::ClientOptions, Client, Database};
use std::env;
...
T: serde::Serialize + serde::de::DeserializeOwned,
{
    ...
    find_one(collection_name, insert_result.unwrap().inserted_id.as_object_id().unwrap()).await
}